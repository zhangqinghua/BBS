...
<!-- Check is login, if no, sendRedirect("login.jsp") -->
...
<%
	...
	try {
		...
		// set the parentArticle to be the leaf.
		if (count <= 0) {
...
<%!// Thought the recircle to find this leaf and delete it.
